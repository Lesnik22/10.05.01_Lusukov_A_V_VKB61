...
#### Защита данных
- **Шифрование файлов**: Все файлы шифруются перед сохранением (Fernet/AES-128)
...
| **Cryptography** | 41.0.4+ | Шифрование файлов (Fernet) |
...
4. **Шифрование**
   ...
   - Файл шифруется с помощью Fernet
...
└──────────────┬──────────────────────────┘
               ...
               ▼
┌─────────────────────────────────────────┐
│  Генерация уникального ключа (Fernet)   │
│  для каждого файла                      │
└──────────────┬──────────────────────────┘
               │
               ▼
...
└──────────────┬──────────────────────────┘
               ...
               ▼
┌─────────────────────────────────────────┐
│  Шифрование мастер-ключом (Fernet)      │
...
- **Формат**: Base64-encoded Fernet key (32 байта)
- **Генерация**: `Fernet.generate_key()`
...
data_key = Fernet.generate_key()  # 32 байта
...
# 2. Шифрование ключа файла мастер-ключом
...
```env
ENCRYPTION_KEY=your_fernet_key_here (base64, 32 bytes)
